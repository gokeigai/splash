...
function format_splash_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    if ($filearea !== 'header' && $filearea !== 'footer' && $filearea !== 'logo' && $filearea !== 'section') {
...
class format_splash extends format_base {
    ...
    public function section_format_options($foreditform = false) {
		...
		//cant get filemanager to load as i need so use this area to enable editsection_form to load my filemanager
    ...
    public function create_edit_form_elements(&$mform, $forsection = false) {
        ...
        if (!$forsection) {
        	...
        	file_prepare_standard_filemanager($COURSE, 'sectionimage', $options, $context, 'format_splash', 'section', $itemid);

			array_push( $elements, $mform->addElement('filemanager', 'sectionimage_filemanager', 'Section Icon', null, $options));

			$mform->addHelpButton('sectionimage_filemanager', 'sectionimage', 'format_splash');

			$mform->setDefault('sectionimage_filemanager', $COURSE->sectionimage_filemanager);
		}
    ...
    public function update_section_format_options($data) {
		...
		if(array_key_exists($key, $data)){
			...
			$data->{$key} = file_postupdate_standard_filemanager($data, $img, $options, $context, 'format_splash', 'section' , $sectionid);
		}
